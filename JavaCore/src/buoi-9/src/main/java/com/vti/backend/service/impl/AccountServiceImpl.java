...
import com.vti.backend.service.importcsv.impl.AccountImportStrategy;
...
public class AccountServiceImpl implements IAccountService {
    ...
    public String importAccountCSV(String pathName) {
        IImportCSVService<AccountImportContext, Account, AccountCSV> importCSVService = new ImportCSVServiceImpl<>();
        return importCSVService.importCSV(pathName, new AccountImportStrategy(accountRepository));
    }
